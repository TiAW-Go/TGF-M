...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_tasks = 1, num_layers = 5, emb_dim = 300, 
        ...
        if   virtual_node == 0:
            ...
            self.gnn_node = TGF_M(num_layers, emb_dim, conv_hop, conv_kernel, JK=JK, gnn_type=gnn_type, use_virt=True, use_att=True)
        else:
    ...
    def forward(self, batched_data, mode):
        h = self.gnn_node(batched_data, mode)
